...
typedef NS_ENUM(NSInteger, RequestAction) {
    ...
    AnchorAward_action = 157,               //实名用户开播时长奖励
    AnchorFirstTimeAward_action = 158,      //首次直播满20分钟奖励
    AudienceWatchTimeAward_action = 159,    //用户观看时长奖励
    SendRedPacket_action=187,                //发送红包接口
    GetRedPacket_action=188,                 //抢红包接口
    RedPacketIsPast_action=189,              //判断红包是否已过期 已抢完
    CreateLiveRoom_QiNiu_action = 191,  // 创建七牛的直播室
    ClosedLiveRoom_QiNiu_action = 192,   //关闭七牛的直播室
};
